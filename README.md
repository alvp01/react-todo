...
Microverse project to larn and practice core React concepts (components, lifecycle methods, hooks) and routing.
...
```
git clone https://github.com/alvp01/react-todo.git
cd ract-todo
npm install
npm run start
```
...
Feel free to check the [issues page](https://github.com/alvp01/ract-todo/issues)
